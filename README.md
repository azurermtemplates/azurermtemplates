...
| <a href="https://azuredeploy.net/?repository=https://github.com/singhkay/VM-Chef-Extension" target="_blank"><img src="http://azuredeploy.net/deploybutton_small.png"/></a> | [singhkay](https://github.com/singhkay) | [VM with Chef extension](https://github.com/coreysa/deploy-docker-container) | This template allows you to deploy a windows VM with Chef extension and run any recipe |
