...
| 27 | <a href="https://azuredeploy.net/?repository=https://github.com/azurermtemplates/azurermtemplates/tree/master/windows-vm-diagnostics-extension" target="_blank"><img src="http://azuredeploy.net/deploybutton_small.png"/></a> | [singhkay](https://github.com/kenazk) | [Windows VM with Azure Diagnostics Extension](https://github.com/azurermtemplates/azurermtemplates/tree/master/windows-vm-diagnostics-extension) | This template creates a VM and deploys the Azure Diagnostics Agent to emit performance metrics from within the VM to a Table in the Storage Account specified. |
