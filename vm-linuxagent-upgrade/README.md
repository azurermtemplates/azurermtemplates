...
This template Create a Linux Virtual Machine with new version of Azure Linux Agent. This template also deploys a Storage Account, Virtual Network, Public IP addresses and a Network Interface.
