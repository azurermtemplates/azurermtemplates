...
It also uses the customData OS parameter to pass the parameters from this template into the . See [this link](http://azure.microsoft.com/blog/2014/04/21/custom-data-and-cloud-init-on-windows-azure/) for more details on Custom Data in VMs.
